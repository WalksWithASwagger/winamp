      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            PLACED.map(([name, left, top]) => /* @__PURE__ */ jsx(Sprite, { name, style: placed(left, top) }, name))
          ]
        }
      )
    }
...
export { ClassicWinampPlayer, EQ_BANDS, EQ_MAX_DB, PlayerProvider, SKIN_SPRITES, SPRITE_DIMS, SkinProvider, Sprite, SpriteButton, WinampPlayer, parsePledit, parseSkin, parseViscolor, usePlayer, usePrefersReducedMotion, useSkin, useSkinContext };
