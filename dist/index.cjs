...
function PlayerProvider({
  ...
  const [shuffle, setShuffleState] = react.useState(false);
  const [repeat, setRepeatState] = react.useState(false);
  ...
  const setBalance = react.useCallback((v) => {
  ...
  const setShuffle = react.useCallback((on) => {
    shuffleRef.current = on;
    setShuffleState(on);
  }, []);
  const setRepeat = react.useCallback((on) => {
...
function Visualizer({ onClose }) {
  ...
  const cycleRef = react.useRef(void 0);
  const resumeRef = react.useRef(void 0);
  const [status, setStatus] = react.useState("loading");
  const [presetName, setPresetName] = react.useState("");
  const loadAt = react.useCallback((i, blend) => {
  ...
  const nextPreset = react.useCallback(() => manual(idxRef.current + 1), [manual]);
  const prevPreset = react.useCallback(() => manual(idxRef.current - 1), [manual]);
  const shufflePreset = react.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "deck-viz", ref: panelRef, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "deck-viz-bar", children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", className: "deck-winbtn", "aria-label": "Previous preset", onClick: prevPreset, children: "\u2039" }),
      /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", className: "deck-winbtn", "aria-label": "Shuffle preset", onClick: shufflePreset, children: "\u292E" }),
...
function EqualizerPanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { id, className: "deck-eq-panel", role: "region", "aria-label": "Equalizer", children: [
...
function PlaylistPanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { id, className: "deck-list", role: "region", "aria-label": "Playlist", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("ol", { className: "deck-list-rows", children: allTracks.map((track) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx("li", { children: /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            track.coverImage ? /* @__PURE__ */ jsxRuntime.jsx("img", { className: "deck-row-cover", src: track.coverImage, alt: "" }) : /* @__PURE__ */ jsxRuntime.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "deck-row-num", children: String(track.number).padStart(2, "0") }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "deck-row-title", children: track.title }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "deck-row-person", children: track.person }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "deck-row-tag", children: isCurrent && playing ? /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "deck-eq", "aria-hidden": "true", children: [
...
function DeckDisplay({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "deck-lcd", children: [
...
function TransportControls({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "deck-ctrl", children: [
    /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", className: "deck-key", onClick: onPrevious, "aria-label": "Previous track", children: "\u23EE" }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", className: "deck-key", onClick: onNext, "aria-label": "Next track", children: "\u23ED" }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "input",
      {
        className: "deck-seek",
...
function useDeckWindowState({
  ...
  const [eqPreset, setEqPreset] = react.useState(null);
  ...
  const onBarDoubleClick = react.useCallback((e) => {
    if (e.target.closest("button")) return;
    setShaded((v) => !v);
  }, []);
  const toggleDoubleSize = react.useCallback(() => {
    setDoubled((v) => {
      persist({ doubled: !v });
      return !v;
    });
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(
            "div",
            {
              ...
              children: [
                markSrc && /* @__PURE__ */ jsxRuntime.jsx(
                  "img",
                  {
          ...
          !shaded && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "deck-body", children: [
            ...
            eqOpen && /* @__PURE__ */ jsxRuntime.jsx(
              EqualizerPanel,
              {
                id: eqPanelId,
                eqGains,
            ...
            listOpen && /* @__PURE__ */ jsxRuntime.jsx(
              PlaylistPanel,
              {
                id: playlistId,
                allTracks,
...
function ClassicWinampPlayer({
  ...
  const shadeButton = /* @__PURE__ */ jsxRuntime.jsx(
    SpriteButton,
    {
  ...
  const closeBtn = /* @__PURE__ */ jsxRuntime.jsx(Sprite, { name: "MAIN_CLOSE_BUTTON", style: placed(264, 3) });
  const dblToggle = /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
...
function ClassicEqWindow({
  ...
  const shadeToggle = /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
